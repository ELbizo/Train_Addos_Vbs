...
If ObjFSO.FolderExists("c:\resumo_sys2\") Then
MsgBox "Essa pasta com analise recente ja existe.",VbExclamation
wscript.sleep 2000
wscript.quit
Elseif Not ObjFSO.FolderExists("c:\resumo_sys2\") Then
ObjFSO.CreateFolder("c:\resumo_sys2\")
End if
...
Objshell.sendkeys "{enter}"
wscript.sleep 2000
Objshell.sendkeys "cd c:\resumo_sys2\"
wscript.sleep 2000
Objshell.sendkeys "{enter}"
wscript.sleep 2000
